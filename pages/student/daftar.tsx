// File: /pages/student/daftar/index.tsx
...
const Daftar = () => {
  ...
  useEffect(() => {
    if (window.location.pathname !== '/student/daftar/') {
      router.push('/student/daftar/'); // Diubah ke /student/daftar/
    }
    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="container mx-auto mt-8 px-4">
        ...
        <div className="flex justify-between mt-10 px-4">
          ...
          <button
            className="bg-[#8B0000] text-white px-6 py-2 rounded-full"
            onClick={() => router.push('/student/daftar2/')} // Diubah ke /student/daftar2/
          >
            Selanjutnya
          </button>
        </div>
