...
const HubungiKami: React.FC = () => {
  ...
  const isStudentPath = pathname === '/student/hubungi-kami';

  // Pilih Navbar dan Footer berdasarkan pathname
  const Navbar = isStudentPath ? NavbarUser : NavbarDefault;
  const Footer = isStudentPath ? FooterUser : FooterDefault;
