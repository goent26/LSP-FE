                        ...
                        <button className="bg-yellow-500 hover:bg-yellow-600 text-white p-2 rounded shadow transition duration-200">
                          ...
                          >
                            <path
                              ...
                              strokeWidth={2}
                              d="M15.232 5.232l3.536 3.536M9 13h3l9-9a2.828 2.828 0 00-4-4l-9 9v3z"
                            />
                            <path
                              strokeLinecap="round"
                              strokeLinejoin="round"
                        ...
                        <button className="bg-green-600 hover:bg-green-700 text-white p-2 rounded shadow transition duration-200">
                          ...
                          >
                            <path
                              ...
                              strokeLinejoin="round"
                              strokeWidth={2}
                              d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-5-5.917V4a2 2 0 10-4 0v1.083A6.002 6.002 0 004 11v3.159c0 .538-.214 1.055-.595 1.436L2 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"
                            />
                          </svg>
                        </button>
                      </td>
